...
```{r}
wordcloud_gsi <- function(df, assunto) {
...
```{r}
wordcloud_gsi(pedidos_clean, "Outros em Defesa Nacional")
```

##### GSI - Acesso negado em assunto "Acesso à informação"

```{r}
wordcloud_gsi(pedidos_clean, "Acesso à informação")
```

##### GSI - Acesso negado em assunto "Direitos Humanos"

```{r}
wordcloud_gsi(pedidos_clean, "Direitos Humanos")
```

##### GSI - Acesso negado em assunto "Direitos Humanos"

```{r}
wordcloud_gsi(pedidos_clean, "Transparência")
```
