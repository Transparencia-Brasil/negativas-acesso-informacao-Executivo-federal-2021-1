...
wafflechart_acesso_negado <- function(df, x, 
  titulo = "Maiores % de negativas de acesso por ano") {
  ...
  df %>%
    ...
    labs(
      title = titulo,
      subtitle = glue(
        "Proporção de pedidos negados em relação ao\n",
        "total de pedidos recebidos pelas pastas ministeriais\n",
        "Valor máximo registrado no ano de referência"
      ),
      x = NULL,
      y = NULL,
      fill = "%"
