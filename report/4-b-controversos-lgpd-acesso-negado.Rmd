...
#### Acesso negado - por órgão (10 primeiros) - após 18/11/2020
...
lgpd %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 55)) +
  labs(
    title = "Acessos negados mencinando a LGPD na resposta - após a vigência da lei",
    subtitle = "Considerando pedidos com data de registro da resposta após 18/11/2020.\nSolicitante não menciona LGPD no pedido",
    x = "Quantidade",
    y = NULL
  ) +
  coord_flip()
...
lgpd %>% 
  ...
  labs(
    ...
    subtitle = "Antes e depois da vigência da lei em 18/11/2020",
    fill = "% de negativas e vigência\nda LGPD em 18/11/2020",
...
lgpd %>% 
  ...
  transmute(
    `Vigência da LGPD` = if_else(vigencia_lgpd, "Depois de 18/11/2020",
                                 "Antes de 18/11/2020"),
