...
load(here("dados/load/dados.RData"))
```
...
save(periodo_final,
     pedidos_por_mes,
     pedidos_mesmo_periodo,
     acessos_concedidos_mesmo_periodo,
     indice_respostas_concedidas,
     rect_gov,
     respostas_comuns,
     aux,
     respostas_comuns_gov,
     file = here("dados/load/dados.RData"))
```
...
> Em 2021 o Governo Federal contabilizou `r pedidos_mesmo_periodo$qt[7]` mil pedidos de informação, concedendo o acesso para `r acessos_concedidos_mesmo_periodo$qt[7]` mil deles (`r scales::percent(indice_respostas_concedidas[[7, 4]])`).
