...
> **A análise é feita excluindo os dados da CEF**: Os pedidos para Caixa Econômica federal não constam na base a partir de 2018.
...
pedidos_cef %>% 
  ...
  labs(
    ...
    subtitle = "Como % das decisões decisões das manifestações registradas no FalaBr"
  ) +
  theme_minimal() +
